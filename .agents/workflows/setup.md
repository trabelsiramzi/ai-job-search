---
name: setup
description: Profile Onboarding for the AI Job Search assistant
---
...
Then proceed to Step 3 to populate the non-skill files (`.agents/rules/job-application-rules.md`, `cv/main_example.tex`, `.agents/skills/job-scraper/search-queries.md`). Step 3 will detect that the seven skill files are already populated and skip those substeps.
...
### 1. Update `.agents/rules/job-application-rules.md`
...
>
> - `.agents/rules/job-application-rules.md` - Your full candidate profile
